...
| `transactionId` | Yes      | String | 01     | Transaction ID from [Initiate](/broken/pages/6YcTSzltQbYW6IjvTITn) |
| `paymentToken`  | Yes      | String | N/A    | Payment token from [Initiate](/broken/pages/6YcTSzltQbYW6IjvTITn)  |
