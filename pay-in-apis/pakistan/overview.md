# Pakistan — Pay-In APIs

Pakistan pay-in integrations use dedicated endpoints separate from the [Unified Pay-In](../unified-pay-in/overview.md) APIs (BD · NP · EG · IQ). Choose the integration method that matches your checkout flow.
...
| [Cards](./cards/overview.md) | Card payments — authorize, capture, void, inquiry, tokenization, and refunds |
