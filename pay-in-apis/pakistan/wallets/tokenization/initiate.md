...
<figure><img src="/files/pXULfbEJavfldHqg8989" alt="JazzCash tokenization hosted page"><figcaption>JazzCash hosted page: customer enters payment details to start tokenization.</figcaption></figure>

After payment details are entered, the customer receives an OTP on a second screen:

<figure><img src="/files/Gy8GWpcsdOTip7Pgx97s" alt="JazzCash tokenization OTP screen"><figcaption>JazzCash: OTP entry screen to approve tokenization.</figcaption></figure>
