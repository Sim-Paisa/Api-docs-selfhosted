...
<figure><img src="/files/X848SJ0nntirynMM1FWi" alt="Wallet tokenization flow"><figcaption>Tokenization: initial consent via Initiate/Verify (or JazzCash hosted page), then Direct Charge using sourceId.</figcaption></figure>
...
| `productId` | Supported (or `amount`) | Uses `amount` on hosted page |
