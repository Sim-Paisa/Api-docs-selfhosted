...
4. **Resolve the beneficiary bank ID:**
   * Call the [List Banks](list-banks.md) API with only your Merchant ID (MID) in the GET request. The response returns a list of banks with their bank codes.
